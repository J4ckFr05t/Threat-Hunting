...
/*
Pseuodocode
Where J(w0, w1) there is a cost production function (mean squared error) and a is the learning rate
repeat until convergence {
    w0 = w0 - a*d/dw0(J(w0, w1))
    w1 = w1 - a*d/dw1(J(w0, w1))
*/
...
int main(){
    ...
    // Start from the point w0 = 0 and w1 = 0
    w0 = 0; w1 = 0;
